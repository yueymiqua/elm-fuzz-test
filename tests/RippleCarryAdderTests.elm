module RippleCarryAdderTests exposing (andGateTests, fullAdderTests, halfAdderTests, inverterTests, orGateTests, rippleCarryAdderProperty1, rippleCarryAdderProperty3, rippleCarryAdderTests)
...
halfAdderTests =
    describe "Half Adder"
        ...
        , test "sum is 1 and carry-out is 0 when the first input is 1" <|
            \_ ->
                halfAdder 1 0
                    |> Expect.equal { carry = 0, sum = 1 }
        , test "sum is 1 and carry-out is 0 when the second input is 1" <|
            \_ ->
                halfAdder 0 1
                    |> Expect.equal { carry = 0, sum = 1 }
